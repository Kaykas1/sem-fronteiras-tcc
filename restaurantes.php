...
<html lang="PT-BR">
    ...
    <body>      
      ...
      <div class="carvalho">
        <p class="objeto">Bem-vindo ao nosso guia de restaurantes acessíveis no Brasil! Nesta página, você 
          ...
          missão de tornar a refeição uma experiência acessível e agradável para todos.</p>
        </div>
      <div class="mapa">
        <iframe src="https://www.google.com/maps/d/embed?mid=17EzAQrfeoxNzYZXnViqh7KMZNYy5L4k&ehbc=2E312F&noprof=1" width="640" height="600"></iframe>
      </div>
      </body>
</html>